...
const ButtonHomeDownload = ({ text = null, href = null, target = null, ariaLabel = null, download = null, imageSRC = null, imageALT = null }) => {
  return (
    <a
      ...
      style={{color:'rgb(255, 255, 255)', backgroundColor: "rgb(0, 85, 128)"}}
      href={href}
      target={target}
      download={download}
      ...
      <span className='h5' >
        {text}
        <svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='currentColor' className='bi bi-cloud-download' viewBox='0 0 16 16'>
...
export default ButtonHomeDownload
