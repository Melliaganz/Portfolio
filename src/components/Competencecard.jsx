...
const CompetenceCard= ({title, details, imageSRC, stackIcons, linkDemo, linkGithub}) => {
    return (
        <div className='col-md-6 col-sm-7 cardInline'>
            <div className='card card-cover border-warning h-100 overflow-hidden rounded-4 shadow ' style={{backgroundImage: `linear-gradient(180deg, rgba(255, 255, 255,0.5) 0%, rgba(255, 255, 255,1) 20%), url(${imageSRC})`}}>
