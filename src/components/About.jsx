  ...
  return (
    ...
    <section id="about"className='container-fluid preface__background--color preface__section mb-5 bg-warning'>
        ...
        <div className="col-12 col-md-6 text-center text-md-center home__title" id="blocTextAbout">
            ...
            <img src="https://upload.wikimedia.org/wikipedia/commons/d/d5/CSS3_logo_and_wordmark.svg" alt={<CssIcon />} height={25} width={25} /> <a href="https://developer.mozilla.org/fr/docs/Web/CSS" >CSS</a> | 
            <img src="https://upload.wikimedia.org/wikipedia/commons/9/99/Unofficial_JavaScript_logo_2.svg" alt={<JavascriptIcon />} height={20.65625} width={18.75} /> <a href="https://developer.mozilla.org/fr/docs/Web/JavaScript" >JavaScript</a> | 
            <img src="https://www.svgrepo.com/show/331488/mongodb.svg" height={25} width={25} alt={<StorageIcon />} /><a href="https://www.mongodb.com/"> MongoDB</a> |
            <img src="https://cdn-icons-png.flaticon.com/512/528/528260.png" height={25} width={25} alt={<StorageIcon />}/> <a href="https://www.mysql.com/"> MySQL</a>|  
            ...
            <img src="https://seeklogo.com/images/N/nodejs-logo-FBE122E377-seeklogo.com.png" height={18.75} width={16.625} alt={<ApiIcon />} /> <a href="https://nodejs.org/en/"> Node.js</a> | 
            <img src="https://seeklogo.com/images/S/sequelize-logo-9A5075DB9F-seeklogo.com.png" height={18.75} width={16.25} alt="ORM" /> <a href="https://sequelize.org/" > Sequelize</a> |
            <img src="https://sass-lang.com/assets/img/styleguide/seal-color-reversed-c50d9b78.png" height={25} width={25} alt="sass" /> <a href="https://sass-lang.com/"> Sass</a> </p>
            <ButtonHomeDownload
