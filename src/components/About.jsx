  ...
  return (
    ...
    <section id="about"className='container-fluid preface__background--color preface__section mb-5 '>
        ...
        <div className="col-12 col-md-6 text-center text-md-center home__title shadow border" id="blocTextAbout">
            ...
            <a href="https://www.mongodb.com/"><img src="https://www.svgrepo.com/show/331488/mongodb.svg" height={25} alt="mongoDB logo" />MongoDB</a> |
            <a href="https://www.mysql.com/"><img src="https://cdn-icons-png.flaticon.com/512/528/528260.png" height={25} alt="mySQL logo"/>MySQL</a>|  
            <a href="https://reactjs.org/" ><img src="https://upload.wikimedia.org/wikipedia/commons/a/a7/React-icon.svg" height={25} alt="ReactLogo" />React.js</a>| 
            <a href="https://nodejs.org/en/"><img src="https://seeklogo.com/images/N/nodejs-logo-FBE122E377-seeklogo.com.png" height={18.75}  alt= "nodeJS logo"/>Node.js</a> | 
            <a href="https://sequelize.org/" ><img src="https://seeklogo.com/images/S/sequelize-logo-9A5075DB9F-seeklogo.com.png" height={18.75} alt="Sequelize logo" />Sequelize</a> |
            <a href="https://sass-lang.com/"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Sass_Logo_Color.svg/2560px-Sass_Logo_Color.svg.png" height={25} alt="sass" /> Sass</a> </p>
            <ButtonHomeDownload
